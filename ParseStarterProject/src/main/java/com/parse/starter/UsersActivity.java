...
public class UsersActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.tweet)
        {
            ...
            final EditText tweeEditText = new EditText(this);
            builder.setView(tweeEditText);
            builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Log.i("Info",tweeEditText.getText().toString());
                    ParseObject tweet = new ParseObject("Tweet");
                    tweet.put("tweet",tweeEditText.getText().toString());
            ...
            builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Log.i("Info","I don'1 want a tweet");
            ...
            public void done(List<ParseUser> objects, ParseException e) {
                if (e == null && objects.size() > 0) {
                    ...
                    for (String username : users) {
                        if ( ParseUser.getCurrentUser().getList("isFollowing")!=null && ParseUser.getCurrentUser().getList("isFollowing").contains(username)  ) {
